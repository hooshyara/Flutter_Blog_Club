...
class $AssetsImgBackgroundGen {
  ...
  /// File path: assets/img/background/background.jpg
  AssetGenImage get background =>
      const AssetGenImage('assets/img/background/background.jpg');

  /// File path: assets/img/background/images.jpg
  AssetGenImage get images =>
      const AssetGenImage('assets/img/background/images.jpg');

  /// File path: assets/img/background/logo.jpg
  AssetGenImage get logo =>
      const AssetGenImage('assets/img/background/logo.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [background, images, logo];
}
...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/google.jpg
  AssetGenImage get google =>
      const AssetGenImage('assets/img/icons/google.jpg');
